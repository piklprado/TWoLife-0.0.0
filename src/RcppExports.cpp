...
static const R_CallMethodDef CallEntries[] = {
    {"_TWoLife_run_twolife_simulation", (DL_FUNC) &_TWoLife_run_twolife_simulation, 26},
    {NULL, NULL, 0}
};
